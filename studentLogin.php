	...
	<div id="studentLogin">
        <div class="row">
        	...
        	<br><br><br><br>
        	    ...
        	    <h3 class="mt-2">Student Portal</h3>
                </div><!-- end of md-3 -->
                </div><!-- end of row -->
        	    <form class="mt-5" name="frmLog" method="post" id="user_log" class="mt-5" action="<?php htmlspecialchars("PHP_SELF"); ?>">
        	    	...
        	    	<div class="d-flex mt-4" id="background">
                     ...
                     <div class="col-md-6" id="forgot">
        	    		...
        	    		<button type="submit" class="btn fw-bold text-light"  name="submit"  onclick="return valLog();">LOG IN</button>
        	    	</div>
        	    	</div>
