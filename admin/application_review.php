  ...
  <div id="navbar-wrapper">
    <nav class="navbar navbar-inverse">
        <div class="navbar-header d-flex">
          ...
          <a class="text-light navbar-brand fs-2 mt-1 text-uppercase" id="dash1">APPLICATION REVIEW AND EVALUATION SYSTEM</a> 
      </div>
            <div class="dropdown">
...
<?php $view_query = mysqli_query($conn, "SELECT * FROM tbl_student_info  limit 10"); ?>
   ...
   $status           = $row["status"];
       ...
       <tr>
         ...
         <td class="text-center text-uppercase">
          ...
          <td class="text-uppercase text-center"><?php echo $status; ?></td>
       </tr>
      <?php endwhile; ?>  
  </tbody>
</table>  
...
<?php require_once "update_delete/review_appcrud.php" ?>
