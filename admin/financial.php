...
<?php $view_query = mysqli_query($conn, "SELECT * FROM tbl_student_info WHERE payment_status='process' and status='approved' limit 10"); ?>
   ...
   $s_email           = $row["s_email"];
       ...
       <tr>
        ...
        <div class="d-flex" style="margin-left: 10%;">
            <?php echo "<a href='payment_process.php?student_id=$student_id'
                   class='btn'><img src='../img/icon/give-money.png' class='img-fluid me-5' width='40'></i></a>"; ?>
