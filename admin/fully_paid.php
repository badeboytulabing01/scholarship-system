...
<?php $view_query = mysqli_query($conn, "SELECT * FROM tbl_student_info WHERE payment_status='fully paid' and status='approved' limit 10"); ?>
  ...
  $username              = $row["username"];
   ...
   $payment_status           = $row["payment_status"];
       ...
       <tr>
         ...
         <form action="review_selection.php" method="POST">
