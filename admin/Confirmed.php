...
<?php require_once "../parts/adminparts/sidebar.php" ?>
  ...
  <div id="navbar-wrapper">
    <nav class="navbar navbar-inverse">
        <div class="navbar-header d-flex">
          ...
          <a class="text-light navbar-brand fs-2 mt-1 text-uppercase" id="dash1">FINANCIAL MANAGEMENT</a> 
      </div>
            <div class="dropdown">
  ...
  <section class="container mt-3" id="adminusers">
      <a href="financial.php" class="btn btn-success me-2">Proccess</a><a href="fully_paid.php" class="btn btn-success">Fully Paid</a> 
      <a href="Confirmed.php" class="btn btn-success"> Student Confirmed</a> 
...
<?php $view_query = mysqli_query($conn, "SELECT * FROM tbl_student_info WHERE payment_status='fully paid (Confirm)' and status='approved' limit 10"); ?>
  ...
  <thead>
    <tr class="text-uppercase text-center text-dark">
      ...
      <th class="col-md-2 col-xs-3">Payment Status</th>
   ...
   $payment_status           = $row["payment_status"];
       ...
       <tr>
        ...
        <div class="d-flex" style="margin-left: 20%;">
          <button name="process" id="process" class="btn"><img src="../img/icon/process.png" class="img-fluid" width="30"></button>  
               <?php echo "<a href='view_studentinfo.php?student_id=$student_id'
                   class='btn'><i class='fa fa-eye fs-3' aria-hidden='true'></i></a>"; ?>     
       </div><!-- end of dflex --> 
    </form><!-- end of form -->
          </td>
          <td class="text-uppercase text-center"><?php echo $payment_status; ?></td>
       </tr>
      <?php endwhile; ?>  
  </tbody>
</table>	
