...
<?php $view_query = mysqli_query($conn, "SELECT * FROM tbl_student_info LEFT JOIN  tbl_requirements ON tbl_student_info.student_id = tbl_requirements.student_id WHERE tbl_requirements.submit_status='approved' limit 10"); ?>
