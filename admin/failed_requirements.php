...
<?php require_once "../parts/adminparts/sidebar.php" ?>
  ...
  <section class="container mt-3" id="adminusers">
      <a href="review_requirements.php" class="btn btn-success me-2">Pending</a><a href="requirements_approved.php" class="btn btn-success">Approved Requirements</a> <a href="failed_requirements.php" class="btn btn-success me-2">Failed</a>    
...
<?php $view_query = mysqli_query($conn, "SELECT * FROM tbl_student_info LEFT JOIN  tbl_requirements ON tbl_student_info.student_id = tbl_requirements.student_id WHERE tbl_requirements.submit_status='failed' limit 10"); ?>
  ...
  $submit_status      = $row["submit_status"];
       ...
       <tr>
         ...
         <form action="approvedrequirements_email.php" method="POST">
         ...
         <input type="hidden" name="student_id" value="<?php echo $row['student_id'];?>">
          ...
          <form action="failed_requirements.php" method="POST">
